...
Instruction LD_R_D8(Cpu_Register);
Instruction LD_R_R(Cpu_Register, Cpu_Register);
...
Instruction SUB_D8();
Instruction SUB_R(Cpu_Register);
...
Instruction AND_D8();
Instruction AND_R(Cpu_Register);
Instruction AND_ADDR_HL();

Instruction XOR_D8();
Instruction XOR_R(Cpu_Register);
Instruction XOR_ADDR_HL();

Instruction OR_D8();
Instruction OR_R(Cpu_Register);
...
Instruction SBC_D8();
Instruction SBC_R(Cpu_Register);
